...
void Menu::render(ShaderProgram* program) {
    ...
    Utility::draw_text(program, font_textureID, "Crazy Adventure!", 1.0f, -0.6f, glm::vec3(1.7f, 1.0f, 0));
    Utility::draw_text(program, font_textureID, "Press Enter to Start", 1.0f, -0.6f, glm::vec3(1.5f, -1.0f, 0));
}