...
{
    92, 0, 0, 0, 0,50, 0, 0, 0, 0,
    27, 0, 0, 0, 0, 0, 0, 0, 0, 0,
    27, 0, 0,50, 0, 0, 0,50,50,50,
    27, 0, 0, 0, 0,50, 0, 0, 0, 0,
    27, 0, 0, 0, 0, 0, 0, 0, 0, 0,
...
void LevelA::initialise()
{
    ...
    state.player->set_position(glm::vec3(4.0f, 0.0f, 0.0f));
    ...
    state.enemies[0].set_position(glm::vec3(9.0f, 2.0f, 0.0f));
    ...
    state.enemies[0].this_level = level1;
...
void LevelA::update(float delta_time)
{
    ...
    if (this->state.player->get_position().x >= 0.4f && this->state.player->get_position().x <= 0.6f && 
        !state.enemies[0].check_live_status() && this->state.player->get_position().y <= 2.2f) {
...
void LevelA::render(ShaderProgram* program)
{
    ...
    if (state.number_of_lives == 0) {
        ...
        Utility::draw_text(program, font_texture_iD, "You Lose", 1.0f, -0.6f, glm::vec3(1.5f, 4.0f, 0));
    ...
    Utility::draw_text(program, font_texture_iD, "Your lives now: ", 1.0f, -0.6f, glm::vec3(1.5f, 4.0f, 0));
    Utility::draw_text(program, font_texture_iD, std::to_string(state.number_of_lives), 1.0f, -0.6f, glm::vec3(8.0f, 4.0f, 0));
}